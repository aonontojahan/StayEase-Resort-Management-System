...
class Room(Base):
    ...
    status: Mapped[RoomStatus] = mapped_column(
        SAEnum(RoomStatus, name="roomstatus"),
        nullable=False,
    ...
    room_type: Mapped[RoomType] = relationship(
        "RoomType", back_populates="rooms", lazy="selectin"
    )
    booking_rooms: Mapped[List["BookingRoom"]] = relationship(
        "BookingRoom", back_populates="room", lazy="selectin"
    )
...
if TYPE_CHECKING:
    from app.bookings.models import BookingRoom
